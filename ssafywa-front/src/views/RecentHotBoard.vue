...
import { getRecentHot } from '@/api/board';
...
<template>
    <div style="margin-top: 7%; ">
        <h2 style="margin-bottom: 3%; margin-left: 10%;"><v-icon size="x-large" color="red">mdi-trending-up</v-icon><span style="color: red;">급상승</span> 게시글</h2>
