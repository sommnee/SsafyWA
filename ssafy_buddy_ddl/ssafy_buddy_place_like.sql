...
CREATE TABLE `place_like` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `place_like_ibfk_1` FOREIGN KEY (`place_id`) REFERENCES `place` (`place_id`) ON DELETE CASCADE,
  CONSTRAINT `place_like_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `member` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `place_like` VALUES (1351,'ssafy'),(1352,'boun00'),(1352,'ssafy'),(1359,'boun00'),(1621,'ssafy'),(1622,'ssafy');
